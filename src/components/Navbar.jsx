...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-slate-950/80 backdrop-blur-md py-4 shadow-lg shadow-cyan-500/10' : 'bg-transparent py-6'}`}>
