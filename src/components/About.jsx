        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="glass p-8 rounded-2xl relative overflow-hidden group h-full">
            ...
            <div className="space-y-4 text-slate-300 text-lg leading-relaxed relative z-10">
              <p>
                Greetings! I'm <strong>Aniket Sapehia</strong>, a 20 year old Computer Science Engineering student,
                 specializing in Machine Learning. My journey in tech is driven by a fascination with data and a
                  desire to build impactful AI solutions, and I'm also very interested in website development. 
                  I'm proficient in Python, Java, HTML5, CSS, and JavaScript, and I'm continuously learning new
                   algorithms and techniques to push the boundaries of what's possible. Check out my repositories 
                   for a glimpse into my learning and projects!
              </p>
              <p>
                I am currently pursuing my <strong>Bachelor of Technology in Computer Science and Engineering</strong> at 
                Lovely Professional University. Whether it's crafting scalable <strong>ML models </strong> 
          ...
          <div className="glass p-8 rounded-2xl relative z-10">
            <h3 className="text-xl font-bold text-slate-100 mb-6 font-mono text-cyan-400 border-b border-white/10 pb-4"> Computer Science Education Journey</h3>
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                ...
                <div className="w-[calc(100%-2rem)] md:w-[calc(50%-1.5rem)] pl-4 md:pl-0 md:group-odd:pr-6 md:group-even:pl-6">
                  <div className="flex flex-col items-start text-left">
                    <span className="text-cyan-400 text-sm font-mono mb-1">Aug '23 - Present</span>
                    ...
                    <span className="inline-block px-3 py-1 bg-cyan-500/10 text-cyan-400 text-xs rounded-full w-fit">CGPA: 7.6</span>
                  </div>
                </div>
              </div>
              {/* 12th Grade */}
